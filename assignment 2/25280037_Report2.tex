...
30 & --- & --- & --- & --- \\
\midrule
\textbf{Best} & --- & --- & --- & \textbf{[insert]} \\
\bottomrule
\end{tabular}
\caption{Tower Model training summary. Fill values from notebook output.}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Champion Model training summary. Fill values from notebook output.}
\end{table}
...
Tower    & $784 \to [256]^8 \to 15$     & 669,455   & 30 & [insert] & [insert] \\
Champion & $784 \to [1024]^3 \to 15$    & 2,924,559 & 40 & [insert] & [insert] \\
\bottomrule
\end{tabular}
